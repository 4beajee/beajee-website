  ...
  return (
    <div className="min-h-dvh bg-transparent">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-[#010103]/60 border-b border-[#1a1a1a]">
        <div className="flex items-center justify-between px-6 h-12 sm:h-14 max-w-3xl mx-auto">
          <Link href="/" className="flex items-center gap-2">
            <span className="text-base font-semibold text-white sm:text-lg tracking-tight leading-none pt-0.5">{t("common.beajee")}</span>
