    ...
    <div className="min-h-dvh bg-[#050505]">
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          className="pointer-events-none absolute left-4 top-[24%] w-10 h-10 select-none animate-agent-codex sm:left-[10%] sm:top-[26%] sm:w-12 sm:h-12 md:left-[12%]"
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-4 top-[20%] w-10 h-10 select-none animate-agent-openclaw sm:right-[8%] sm:top-[22%] sm:w-12 sm:h-12 md:right-[10%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
        ...
        <svg
          ...
          fillRule="evenodd"
          viewBox="0 0 24 24"
          className="pointer-events-none absolute left-6 bottom-[26%] w-10 h-10 select-none animate-agent-hermes sm:left-[12%] sm:bottom-[28%] sm:w-12 sm:h-12 text-white md:left-[14%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
          style={{ flex: "none", lineHeight: 1 }}
        >
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-6 bottom-[22%] w-10 h-10 select-none animate-agent-claude sm:right-[14%] sm:bottom-[24%] sm:w-12 sm:h-12 text-white md:right-[16%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
