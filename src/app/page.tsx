    ...
    <div className="min-h-dvh bg-transparent">
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          className="pointer-events-none absolute left-4 top-[18%] w-12 h-12 select-none animate-agent-codex sm:left-[10%] sm:top-[20%] sm:w-16 sm:h-16 md:left-[12%]"
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-4 top-[14%] w-12 h-12 select-none animate-agent-openclaw sm:right-[8%] sm:top-[16%] sm:w-16 sm:h-16 md:right-[10%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute left-5 top-[46%] w-12 h-12 select-none animate-agent-facebook sm:left-[11%] sm:top-[48%] sm:w-16 sm:h-16 md:left-[13%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-5 top-[46%] w-12 h-12 select-none animate-agent-kimi sm:right-[11%] sm:top-[48%] sm:w-16 sm:h-16 md:right-[13%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
          <title>Kimi</title>
        ...
        <div
          className="pointer-events-none absolute left-6 bottom-[20%] flex h-12 w-12 items-center justify-center rounded-full bg-white p-2 text-black shadow-sm select-none animate-agent-hermes sm:left-[12%] sm:bottom-[22%] sm:h-16 sm:w-16 sm:p-2.5 md:left-[14%] overflow-hidden"
        >
          <svg
            fill="currentColor"
            fillRule="evenodd"
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-6 bottom-[16%] w-12 h-12 select-none animate-agent-claude sm:right-[14%] sm:bottom-[18%] sm:w-16 sm:h-16 text-white md:right-[16%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
