    ...
    <div className="min-h-dvh bg-[#050505]">
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          className="pointer-events-none absolute left-4 top-[18%] w-14 h-14 select-none animate-agent-codex sm:left-[10%] sm:top-[20%] sm:w-20 sm:h-20 md:left-[12%]"
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-4 top-[14%] w-14 h-14 select-none animate-agent-openclaw sm:right-[8%] sm:top-[16%] sm:w-20 sm:h-20 md:right-[10%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
        ...
        <svg
          style={{ flex: "none", lineHeight: 1 }}
          viewBox="0 0 24 24"
          className="pointer-events-none absolute right-5 top-[46%] w-14 h-14 select-none animate-agent-kimi sm:right-[11%] sm:top-[48%] sm:w-20 sm:h-20 md:right-[13%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
        >
          <title>Kimi</title>
        ...
        <svg
          ...
          fillRule="evenodd"
          viewBox="0 0 24 24"
          className="pointer-events-none absolute left-6 bottom-[20%] w-14 h-14 select-none animate-agent-hermes sm:left-[12%] sm:bottom-[22%] sm:w-20 sm:h-20 text-white md:left-[14%]"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
          style={{ flex: "none", lineHeight: 1 }}
        >
